...
desc funcionarios;
insert into funcionarios (nome, cpf, data_nascimento, endereco, telefone, email, cargo, salário, data_admissão) values 
...
insert into clientes (nome, cpf, data_nascimento, endereco, telefone, email, data_cadastro) values
                     ...
                     ('Camila Rodrigues', '456.789.012-34', '1998-05-24', 'Rua Augusta, 2530, São Paulo', '11987654567', ' camila.rodrigues@email.com ', '2023-01-12'),
                     ...
                     ('Patrícia Almeida', '912.345.678-90', '1987-06-19', 'Rua Haddock Lobo, 1327, São Paulo', '11987660123', ' patricia.almeida@email.com ', '2023-01-12'),
...
insert into produtos (nome, descricao, preço, categoria) values      
                     ...
                     ('Caipirinha de Limão', 'Caipirinha tradicional brasileira feita com cachaça, limão e açúcar.', 15.00, 'Bebida'),
...
insert into info_produtos (id_produto, ingredientes, fornecedor) values 
                          ...
                          (15, 'Salmão, leguminosas, alcaparras', 'Pescados do Norte e Hortifruti Natural da Terra'),
...
update funcionarios
set cargo = 'Garçonete', salário = 2700
