...
select id_produto, ingredientes from info_produtos where ingredientes like 'Carn%';
...
select nome from produtos where categoria like 'Prato Principal' limit 2 offset 5;
